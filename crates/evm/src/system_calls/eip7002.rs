...
use revm::{interpreter::Host, Database, Evm, SyncDatabase};
use revm_primitives::{ChainAddress, ExecutionResult, ResultAndState};
    ...
    EvmConfig: ConfigureEvm<Header = Header>,
{
    ...
    // cleanup the state
    res.state.remove(&ChainAddress(evm.block().coinbase.0, alloy_eips::eip7002::SYSTEM_ADDRESS));
