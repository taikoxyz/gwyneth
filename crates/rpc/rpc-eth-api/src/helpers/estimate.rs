...
use revm_primitives::{db::SyncDatabase, EnvWithHandlerCfg};
use tracing::trace;
use reth_revm::database::SyncEvmStateProvider;
...
pub trait EstimateCall: Call {
        ...
        S: StateProvider,
    {
        ...
        if let Some(state_override) = state_override {
            apply_state_overrides(chain_id, state_override, &mut db).map_err(Self::Error::from_eth_err)?;
        }
