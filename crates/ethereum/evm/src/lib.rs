...
use revm_primitives::{
    AnalysisKind, BlobExcessGasAndPrice, BlockEnv, CfgEnv, CfgEnvWithHandlerCfg, ChainAddress, Env, SpecId, TransactTo, TxEnv,
};
...
impl ConfigureEvmEnv for EthEvmConfig {
    ...
    fn next_cfg_and_block_env(
        ...
        let block_env = BlockEnv {
            ...
            coinbase: ChainAddress(self.chain_spec.chain().id(), attributes.suggested_fee_recipient),
